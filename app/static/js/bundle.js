...
document.addEventListener('keydown', (e) => {
  ...
  if (e.code === 'Enter' && searchIsFocused && hasSearchValue)
    _views_base__WEBPACK_IMPORTED_MODULE_7__.elements.nav.quickSearchBtn.click();
});
