...
const navigateTypesDropDown = e => {
    ...
    if (e.code === 'ArrowDown' && i < types.length - 1) {
        ...
        searchView.setScrollTopOnDownArrow(types[i + 1], elements.apiSearch.typeDropDown);
    }
...
const navigateSetsDropDown = e => {
    ...
    if (e.code === 'ArrowDown' && i < sets.length - 1) {
        ...
        searchView.setScrollTopOnDownArrow(sets[i + 1], elements.apiSearch.setDropDown);
    }
    ...
    if (e.code === 'ArrowUp' && i > 0) {
        ...
        searchView.setScrollTopOnUpArrow(sets[i - 1], elements.apiSearch.setDropDown);
    }
